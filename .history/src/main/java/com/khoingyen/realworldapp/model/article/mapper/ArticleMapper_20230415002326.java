...
public class ArticleMapper {
    ...
    public static ArticleDTOResponse toArticleDTOResponse(Article article, boolean favorited, int favoriteCount) {
        return ArticleDTOResponse.builder()
                ...
                .author(toAuthorDTOResponse(article.getAuthor()))
                .build();
    }

    private static AuthorDTOResponse toAuthorDTOResponse(User author) {
        return AuthorDTOResponse.builder().build();
    }
