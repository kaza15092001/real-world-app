...
public class ArticleCriteria {
    ...
    public void findAll(ArticleDTOFilter filter) {
        StringBuilder query = new StringBuilder("select a from Article a inner join a.author au inner join a.userFavorited ufa where 1=1");
        ...
        if(filter.getFavorited() != null) {
         ...
         String countQuery = query.toString().replace("select a", "select count(a)")
    }
}
